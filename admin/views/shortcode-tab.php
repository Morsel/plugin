<div id="morsel_post_display-details" class="shorcode-summry">	
	...
	<form method="post" action="" id="morsel-shortcode-form">
	   <table class="form-table">
	  		<tr valign="top">
	  			<td class="wid-15" scope="row">Count * : </td>
	  		...
	  		<tr valign="top">
				...
				<td><input type="text" name="morsel_shortcode_gap" id="morsel_shortcode_gap" value=""/>
	  		...
	  		<tr valign="top">
				...
				<td><input type="text" name="morsel_wrapper_width" id="morsel_wrapper_width" value=""/>
